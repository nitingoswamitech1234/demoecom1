...
const HomePage = () => {
  return (
    <div className="w-full min-h-screen flex flex-col font-sans bg-[#faf9f6]">
      {/* Navbar */}
      <header className="w-full border-b bg-[#1f1f1f] shadow-sm text-[#f5f3ef]">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-3">
          <div className="text-xl font-bold text-[#d4af37]">
            Your <span className="text-[#f5f3ef]">Logo</span>
          </div>

          <nav className="hidden md:flex space-x-6 text-sm font-medium">
            <a href="#" className="hover:text-[#d4af37]">Sash Cords</a>
            <a href="#" className="hover:text-[#d4af37]">Window Fittings</a>
            <a href="#" className="hover:text-[#d4af37]">Period Door Furniture</a>
            <a href="#" className="hover:text-[#d4af37]">Weatherseals</a>
            <a href="#" className="hover:text-[#d4af37]">Accessories</a>
            <a href="#" className="text-red-500 font-semibold">Clearance</a>
          ...
          <div className="flex items-center gap-2">
            <input
              type="text"
              placeholder="Search..."
              className="hidden md:block border border-[#d4af37]/40 bg-transparent text-[#f5f3ef] px-3 py-1 rounded-md text-sm placeholder:text-gray-300"
            />
            <button className="bg-[#d4af37] text-black px-4 py-1 rounded-md hover:bg-[#b9962e]">
              Search
            </button>
          </div>
        </div>
      ...
      <section className="w-full bg-[#f9f8f5]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 py-12 gap-6">
          <div className="flex-1">
            <h1 className="text-3xl md:text-5xl font-bold text-[#1f1f1f] mb-4 leading-tight">
              Timeless Fittings <br /> for Windows & Doors
            </h1>
            <p className="text-[#3f3f3f] mb-6 leading-relaxed">
            ...
            <button className="bg-[#d4af37] text-black px-6 py-2 rounded-md font-medium hover:bg-[#b9962e] transition">
              Get in touch
            </button>
          </div>
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 px-6 py-10 text-center">
        <div className="flex flex-col items-center">
          <PackageCheck className="w-10 h-10 text-[#d4af37] mb-3" />
        ...
        <div className="flex flex-col items-center">
          <Truck className="w-10 h-10 text-[#d4af37] mb-3" />
          <p className="font-semibold text-[#2e2e2e]">
        ...
        <div className="flex flex-col items-center">
          <Briefcase className="w-10 h-10 text-[#d4af37] mb-3" />
          <p className="font-semibold text-[#2e2e2e]">
        ...
        <div className="flex flex-col items-center">
          <Settings className="w-10 h-10 text-[#d4af37] mb-3" />
          <p className="font-semibold text-[#2e2e2e]">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={idx}
              className="border border-[#d4af37]/30 rounded-lg p-4 flex flex-col items-center text-center bg-white shadow-sm hover:shadow-md transition"
            >
              <img src="/doorlock1.webp" alt={item} className="mb-3" />
              <p className="text-sm font-medium text-[#2e2e2e]">{item}</p>
            </div>
          ))}
        </div>
        <button className="mt-6 px-4 py-2 border border-[#d4af37] text-[#1f1f1f] rounded-md hover:bg-[#d4af37] hover:text-black transition">
          Next
        </button>
      </section>
      ...
      {/* New Items */}
      <section className="max-w-7xl mx-auto px-6 py-10">
        <h2 className="text-2xl font-bold mb-6 text-[#1f1f1f]">New items</h2>
        <div className="flex gap-4 overflow-x-auto pb-4">
          {[
            ...
            <div
              key={idx}
              className="min-w-[200px] border border-[#d4af37]/30 rounded-lg p-4 bg-white shadow-sm hover:shadow-md transition"
            >
              <img src="/lock2.webp" alt={item} className="mb-3" />
              <span className="text-xs bg-[#d4af37] text-black px-2 py-1 rounded-md font-medium">
                NEW
              </span>
              <p className="text-sm mt-2 font-medium text-[#2e2e2e]">{item}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-[#1f1f1f] text-[#f5f3ef] mt-auto">
        <div className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-2 gap-6">
          <div>
            <p className="font-semibold text-lg text-[#d4af37]">Timeless Direct</p>
            <p className="mt-2 text-sm">
              Unit 2a, Hall Moss Business Park, Bolton Road, Bull Hill, Darwen BB3 2TT
            </p>
        ...
        <div className="text-center text-xs py-3 border-t border-[#d4af37]/30">
